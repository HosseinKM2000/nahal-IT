        ...
        <div className='flex flex-col gap-8 p-20 text-gray-4444 items-start '>
            ...
            <div className='flex flex-col gap-3'>
                ...
                <div className='flex flex-row gap-5 text-green-137 mr-20'>
                    <Link to="https://www.instagram.com/nahal_it_official"><BsInstagram className='w-7 h-7'/></Link>
                    <Link to="https://telegram.me/nahal_it"><BsTelegram className='w-7 h-7'/></Link>
                    <Link to="https://youtube.com/nahal_it"><BsYoutube className='w-7 h-7'/></Link>
                    <Link to="https://aparat.com/nahal_it"><FaVideo className='w-7 h-7'/></Link>
                </div>
            </div>
