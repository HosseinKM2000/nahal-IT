  ...
  return (
    <div className='Seo-content flex flex-col items-center gap-10 mb-10 mt-2'>
        <div className='flex flex-col gap-10 px-1'>
            ...
            <div>
                <motion.h1 whileInView={{x:[10,-10,10,-10,10,0]}} transition={{duration:1}} viewport={{once:true}} className='text-center text-green-02'>خدمات وب سایت و سئو وب سایت</motion.h1>
            ...
            <div className='flex flex-row'>
                ...
                <motion.img src={Img_1} alt="roocket" className='w-80' whileInView={{rotate:[10,-10,10,-10,10,-10,0]}} transition={{duration:1}} viewport={{once:true}}/>
            </div>
            ...
            <div className='flex flex-row'>
                ...
                <motion.img src={Img_2} alt="search-engine" className='w-80 h-60' whileInView={{scale:[0,1]}} transition={{duration:1}} viewport={{once:true}}/>
            </div>
            <motion.div whileInView={{opacity:[0,1]}} transition={{duration:1}} viewport={{once:true}}>
            ...
            <div className='flex flex-row'>
                ...
                <motion.img src={Img_3} alt="SERP" className='w-80' whileInView={{scale:[0,1]}} transition={{duration:1}} viewport={{once:true}}/>
            </div>
            ...
            <motion.div whileInView={{opacity:[0,1],x:[1000,0]}} transition={{duration:2,delay:1}} viewport={{once:true}} className='flex flex-col gap-3'>
                ...
                <div className='flex flex-row justify-center gap-1 '>
                    <div className='flex flex-col items-center w-1/3 gap-2 justify-between'>
                        ...
                        <p className='text-center font-thin text-sm leading-8 text-gray-77'>سئو حرفه ای انواع وب سایت ها و افزایش رتبه سایت و افزایش فروش ، با استفاده از جدید ترین روش های سئو وب سایت</p>
                    </div>
                    <div className='flex flex-col items-center w-1/3 gap-2 justify-between'>
                        <img src={Img_6} alt="head-visit-website" className='w-32'/>
                        <span className='font-bold text-black'>افزایش بازدید سایت</span>
                        <p className='text-center font-thin text-sm leading-8 text-gray-77'>افزایش بازدید سایت بعد از سئو، مهم ترین اصل برای افزایش فروش و برندسازی هر کسب و کار است که با تیم زبده نهال آی تی، این امکان برای شما فراهم خواهد شد.</p>
                    </div>
                    <div className='flex flex-col items-center w-1/3 gap-2 justify-between'>
                        <img src={Img_7} alt="seo-service" className='w-32'/>
                        <span className='font-bold text-black'>رسیدن به صفحه اول گوگل</span>
                        <p className='text-center font-thin text-sm leading-8 text-gray-77'>افزایش رتبه وب سایت شما و رسیدن به صفحات بالاتر و رسیدن به صفحه اول گوگل، که منجر به افزایش مشتریان شما و افزایش فروش شما می شود.</p>
                    </div>
                </div>
            </motion.div>
            ...
            <button className='text-white hover:brightness-105 transition-all bg-green-57C w-11/12 py-2 rounded-md text-sm'>سفارش پروژه طراحی انواع وب سایت و سئو</button>
             </div>
