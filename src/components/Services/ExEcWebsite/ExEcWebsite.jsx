  ...
  return (
    <div className='flex flex-col gap-7 ExEcWebsite-content mb-10 mt-2'>
        ...
        <div className='flex flex-col mb-10'>
          ...
          viewport={{once:true}}
          >فروش انواع سایت های اختصاصی و اقتصادی</motion.h1>
          <motion.p initial={{opacity:0}} viewport={{once:true}}  whileInView={{opacity:1}} transition={{duration:0.5}}>فعالیت تیم نهال آی تی در حوزه دیجیتال مارکتینگ مجری پروژه طراحی سایت شرکتی و ساخت سایت فروشگاهی برندهای معتبر داخلی و بین المللی می باشد و هر نمونه طراحی سایت و فروش قالب سایت، متناسب با نیاز و ماهیت هر برند به شکلی منحصر به فرد طراحی و پیاده سازی می‌شود.</motion.p>
          <motion.p initial={{opacity:0}} viewport={{once:true}}  whileInView={{opacity:1}} transition={{duration:0.8}}>داشتن یک وب ‌سایت برای کسب و کار خود، یکی از مهمترین فاکتورهای بازاریابی آنلاین به حساب می‌آید.</motion.p>
        ...
        >
          ...
          <p>– اگر شما مجبور شوید در تیم کد نویسی خود تغییراتی ایجاد کنید، جنگو این امکان را به شما می دهد تا تیم جدید را پیدا کنید تا معماری پروژه شما را با تلاش کمی درک کند که این موضوع می تواند باعث صرفه جویی در پول و هزینه ی شما تا حد زیادی شود.</p>
        ...
        <div className='flex flex-col sm:flex-row justify-center items-center'>
          ...
          >
            ...
            <p>PHP یک زبان برنامه نویسی است که میتوانیم با استفاده از آن اقدام به ساخت صفحات وب داینامیک (Dynamic) کنیم. با استفاده از PHP میتوانیم سایت و اپلیکیشن های تحت وب قدرتمندی را برنامه نویسی کنیم.</p>
        ...
        <motion.div initial={{translateX:0,opacity:1}} viewport={{once:true}} transition={{duration:1}} whileInView={{translateX:[5,-5,5,-5,5,-5,5,-5,0],opacity:1}} >
          ...
          <p>در ادامه‌ی پاسخ به سوال PHP چیست؟ میخواهیم درباره‌ی دو موضوع صفحات وب داینامیک (Dynamic) و استاتیک (Static) صحبت کنیم و خیلی ساده آن‌ها را توضیح دهیم.

فرض کنید که شما در سایت‌تان یک بخشی دارید که میخواهید آخرین اخبار شرکت خودتان را نمایش دهید. برای نمایش این اخبار، از ۲ روش میتوانید استفاده کنید:</p>
          <p><b className='text-base'>روش اول:</b> بصورت دستی وارد کدهای HTML سایت خودتان شوید و اخبار را در کدهای HTML بصورت دستی بنویسید.</p>
          <p><b className='text-base'>روش دوم:</b> اخبار را ابتدا وارد پایگاه داده یا دیتابیس بکنید و سپس با استفاده از یک زبان برنامه نویسی مثل PHP، آن اخبار را از دیتابیس بخوانید و به کاربران نشان دهید.</p>
        ...
        <div>
          ...
          <p>این فریم ورک در بین سایر فریم ورک‌های PHP از امنیت و سرعت توسعه‌ی بیشتری برخوردار است و از طریق آن شما قادر خواهید بود بدون اینکه تغییری در کدهای اصلی ایجاد کنید، عملکرد بسیاری از بخش‌ها را تغییر دهید. </p>
          <p>سوالی که بسیاری از برنامه‌نویسان در خصوص فریم ورک laravel دارند این است که آیا فریمورک لاراول تاثیری بر سرعت انجام پروژه آنها دارد؟</p>
          <p>لاراول دارای امکانات و ویژگی‌هایی است که قطعا بر سرعت انجام پروژه‌ها تاثیر می‌گذارد. با ما همراه باشید تا به بررسی برخی از این ویژگی‌ها بپردازیم:</p>
          <p>Service Container: این امکان به عنوان ابزاری قدرتمند وابستگی بین کلاس‌ها را مدیریت می‌کند.</p>
          <p>Queues : تعریف صف در لاراول، به شما این امکان را می‌دهد تا در انجام اموری که زمان زیادی نیاز دارند وقفه ایجاد کنید و در خصوص زمان انجام آن، بعدا تصمیم‌گیری کنید. لاراول دارای یک API متمرکز، برای مدیریت صف است.</p>
          <p>Events: در لاراول، شما به راحتی می‌توانید بر هر اتفاقی که در اپلیکیشن شما رخ می‌دهد نظارت کنید و به سرعت ریشه خطاها را پیدا کنید.</p>
