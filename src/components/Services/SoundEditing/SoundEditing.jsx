    ...
    <div className='soundEditing-content flex flex-col items-center gap-10 mb-10 mt-2'>
        <div className='flex flex-col gap-10 px-1'>
            ...
            <div className='flex flex-row justify-between items-center'>
                ...
                <motion.img src={img_1} alt="soundEditing" className='w-96' whileInView={{x:[-1000,0],opacity:[0,1]}} transition={{duration:2}} viewport={{once:true}} />
            </div>
            ...
            <div>
                <motion.h5 whileInView={{x:[1000,0],opacity:[0,1]}} transition={{duration:1}} viewport={{once:true}}  className='text-green-1c'>نرم افزارهای حرفه ای ویرایش صدا</motion.h5>
                <p>در ادامه به معرفی چند نرم افزار محبوب و حرفه ای تدوین صدا میپردازیم :</p>
            </div>
            <div className='flex flex-row items-center justify-between'>
                <div>
                    <motion.h6 whileInView={{y:[500,0],opacity:[0,1]}} transition={{duration:1}} viewport={{once:true}} className='text-green-1c'>1 - نرم افزار سونی وگاس</motion.h6>
                ...
                <motion.img src={img_2} alt="sonyVegas" className='w-64' whileInView={{x:[-700,0],opacity:[0,1]}} transition={{duration:1}} viewport={{once:true}} />
            </div>
            <div className='flex flex-row items-center justify-between'>
                <div>
                ...
                <motion.img src={img_3} alt="cyberlink audio director" className='w-64' whileInView={{x:[-500,0],opacity:[0,1]}} transition={{duration:1}} viewport={{once:true}}/>
            </div>
            <div className='flex flex-row items-center justify-between'>
                <div>
                ...
                <motion.img src={img_4} alt="Adobe Audition" className='w-64' whileInView={{x:[-500,0],opacity:[0,1]}} transition={{duration:1}} viewport={{once:true}}/>
            </div>
        ...
        <motion.div whileInView={{y:[200,0],opacity:[0,1]}} transition={{duration:1.5,delay:0.5}} viewport={{once:true}} className='flex flex-row items-center bg-green-d5 px-1 py-5 w-full'>
