  ...
  return (
    <div className='Graphic-content flex flex-col items-center gap-10 mb-10 mt-2'>
        <div className='flex flex-col gap-14 px-1'>
            ...
            <div>
                <motion.h1 className='text-green-1c' whileInView={{y:[100,-20,20,-10,10,-10,0],opacity:[0,1]}} transition={{duration:0.9}} viewport={{once:true}}>طراحی بنر</motion.h1>
            ...
            <div>
                <motion.h2  whileInView={{y:[-50,0],opacity:[0,1]}} transition={{duration:0.9}} viewport={{once:true}} className='text-green-1c'>طراحی هویت بصری</motion.h2>
            ...
            <div>
                <motion.h3  whileInView={{x:[-1000,0],opacity:[0,1]}} transition={{duration:0.9}} viewport={{once:true}} className='text-green-1c'>طراحی استند</motion.h3>
            ...
            <div className='flex flex-row gap-5 items-center'>
                ...
                <motion.img src={Img_1} alt="UI-UX" className='w-80'  whileInView={{x:[-700,0],opacity:[0,1]}} transition={{duration:0.9}} viewport={{once:true}}/>
            </div>
            <motion.div whileInView={{x:[-1000,0]}} transition={{duration:0.9}} viewport={{once:true}} className='flex flex-row gap-5 items-center'>
            ...
            <div className='flex flex-row gap-5 items-center'>
                ...
                <motion.img src={Img_3} alt="teaser" className='w-80' whileInView={{x:[1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}/>
            </div>
            <div className='flex flex-row gap-5 items-center'>
                <motion.img src={Img_4} alt="character" className='w-80' whileInView={{x:[-1000,0],opacity:[0,1]}} transition={{duration:1}} viewport={{once:true}}/>
            ...
            <div className='flex flex-row gap-5 items-center'>
                ...
                <motion.img src={Img_5} alt="catalog-design" className='w-80' whileInView={{x:[1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}/>
            </div>
            <div className='flex flex-row gap-5 items-center'>
                <motion.img src={Img_6} alt="logo-design" className='w-80' whileInView={{x:[-1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}/>
                <motion.div whileInView={{x:[-1000,0],opacity:[0,1]}} transition={{duration:1}} viewport={{once:true}}>
            ...
            <motion.div className='flex flex-row gap-5 items-center' whileInView={{x:[1000,0],opacity:[0,1]}} transition={{duration:1}} viewport={{once:true}}>
                <div>
            ...
            <div className='flex flex-row gap-5 items-center'>
                <motion.img src={Img_8} alt="catalog" className='w-80' whileInView={{x:[-1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}/>
                <motion.div whileInView={{x:[-1000,0],opacity:[0,1]}} transition={{duration:1}} viewport={{once:true}}>
            ...
            <motion.div className='flex flex-row gap-5 items-center' whileInView={{x:[1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}>
                <div>
