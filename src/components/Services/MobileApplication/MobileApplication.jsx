  ...
  return (
    <div className='MobileApplication-content flex flex-col items-center gap-10 mb-10 mt-2'>
        <div className='flex flex-col gap-10 px-1'>
            ...
            <div className='flex flex-row'>
                <div className='text-justify'>
                    ...
                    <motion.p whileInView={{x:[1000,0],opacity:[0,1]}} transition={{duration:1.5,delay:0.5}} viewport={{once:true}}>در این وب‌سایت در تعریف اپلیکیشن آمده است: اپلیکیشن موبایل بانام مخفف app نوعی نرم‌افزار رایانه‌ای به شمار می‌آید که از آن برای ارتباط نهایی کاربران استفاده شده و قابلیت اجرا بر روی سیستم‌عامل گوشی‌های هوشمند را دارد.</motion.p>
                ...
                <motion.img src={img_1} alt="application or softwar" className='w-1/2 h-80' whileInView={{x:[-700,0],opacity:[0,1]}} transition={{duration:1.5,delay:0.5}} viewport={{once:true}}/>
            </div>
            <div>
            ...
            <div className='flex flex-row gap-5 items-center justify-around'>
                <div>
                    ...
                    <motion.p whileInView={{x:[1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}>افزایش انگیزه تعامل برای کاربران</motion.p>
                    <motion.p whileInView={{x:[1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}>کاهش هزینه و افزایش درآمد</motion.p>
                    <motion.p whileInView={{x:[1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}>افزایش ترویج وفاداری مشتری</motion.p>
                    <motion.p whileInView={{x:[1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}>پیشی گرفتن از سایر رقبا</motion.p>
                ...
                <motion.img src={img_2} alt="benifits-exclusive-application" className='w-1/2' whileInView={{x:[-700,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}/>
            </div>
            <div>
            ...
            <div className='flex flex-row justify-around items-center'>
                ...
                <motion.img whileInView={{x:[-700,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}  src={img_4} alt="android-application" className='w-96'/>
            </div>
            <div className='flex flex-row items-center justify-around'>
                ...
                <motion.img src={img_5} alt="java-application" className='w-80' whileInView={{x:[-700,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}/>
            </div>
            <div className='flex flex-row items-center justify-around'>
                <div className='w-2/4'>
                ...
                <motion.img whileInView={{x:[-700,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}} src={img_6} alt="ios-appliacation" className='w-80'/>
            </div>
        ...
        <div className='flex flex-col w-full'>
            <motion.div className='flex flex-row items-center bg-green-d5 px-1 py-5' whileInView={{y:[300,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}>
