  ...
  return (
    <div className='proposal-content flex flex-col items-center gap-10 mb-10 mt-2'>
        <div className='flex flex-col gap-10 px-1'>
            ...
            <motion.div className='flex flex-row gap-10 items-center justify-start' whileInView={{rotate:[-90,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}>
                <div>
                ...
                <motion.img src={Img_1} alt="plan" className='w-80' whileInView={{x:[-300,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}/>
            </motion.div>
            <motion.div className='flex flex-row items-center gap-5' whileInView={{x:[-1000,0],skew:[-100,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}>
            ...
            <motion.div className='flex flex-row gap-5 items-center' whileInView={{rotate:[10,-10,10,-10,10,-10,0]}} transition={{duration:1.5}} viewport={{once:true}}>
                <div>
        ...
        <motion.div className='flex flex-row items-center bg-green-d5 px-1 py-5 w-full' whileInView={{y:[200,0],opacity:[0,1]}} transition={{duration:1.5,delay:0.5}} viewport={{once:true}}>
