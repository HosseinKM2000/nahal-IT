    ...
    <div className='ExWebDesign-content flex flex-col items-center gap-10 mb-10 mt-2'>
        <div className='flex flex-col gap-10 px-1'>
            ...
            <div className='flex flex-row'>
              ...
              <motion.img  whileInView={{x:[-500,20,-20,0]}} transition={{duration:1}} viewport={{once:true}} src={Img_1} alt="Img_1" className='w-80'/>
            </div>
            <div className='flex flex-row'>
              <motion.img src={Img_2} alt="Img_2" className='w-80' whileInView={{x:[1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}/>
              <div>
            ...
            <div className='flex flex-row'>
              ...
              <motion.img src={Img_3} alt="Img_3" className='w-80'  whileInView={{y:[500,0],opacity:[0,1]}} transition={{duration:1}} viewport={{once:true}}/>
            </div>
            <div className='flex gap-3 flex-row'>
              <motion.img src={Img_4} alt="Img_4" className='w-80'  whileInView={{y:[-300,0],opacity:[0,1]}} transition={{duration:1}} viewport={{once:true}}/>
              <div>
            ...
            <motion.div  whileInView={{x:[1000,0],opacity:[0,1]}} transition={{duration:2.2}} viewport={{once:true}}>
              ...
              <div className='flex flex-row gap-2'>
                <div className='w-1/3 flex flex-col items-center gap-2'>
                  ...
                  <p className='text-gray-66 text-center leading-8 text-sm'>دوست دارید آدرس وب‌ سایت شما چه باشد؟ شما می‌ توانید خیلی سریع دامنه مورد نظرتان را ثبت کنید یا دامنه‌ قبلی خود را به سایت متصل نمایید.</p>
                </div>
                <div className='w-1/3 flex flex-col items-center gap-2'>
                  <img src={Img_5} alt="Img_5" className='w-28'/>
                  <span className='font-bold text-gray-66'>قالب‌ های مناسب و جذاب</span>
                  <p className='text-gray-66 text-center leading-8 text-sm'>طراحی انواع قالب های گرافیکی زیبا و همچنین بهینه سازی انواع قالب ها متناسب با سلیقه کاربر به همراه پشتیبانی از سایت</p>
                </div>
                <div className='w-1/3 flex flex-col items-center gap-2'>
                  <img src={Img_6} alt="Img_6" className='w-28'/>
                  <span className='font-bold text-gray-66'>ایجاد پنل برای مدیریت آسان سایت</span>
                  <p className='text-gray-66 text-center leading-8 text-sm'>کار با پنل مدیریت سایت واقعاً ساده است و هر کسی از پس مدیریت آن بر خواهد آمد. بنابراین در آینده به هیچ مشکلی برخورد نمی‌کنید.</p>
                </div>
              </div>
            </motion.div>
            <div className='mb-32'>
