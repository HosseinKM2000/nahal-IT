...
function Business() {
  return (
    <div className='Business-content flex flex-col items-center gap-10 mb-10 mt-2'>
        <div className='flex flex-col gap-10 px-1'>
            ...
            <div className='flex flex-row'>
                ...
                <motion.img src={brandImg} alt="brand" className='w-80' whileInView={{x:[1000,0] , opacity:[0,1]}} transition={{duration:1}} viewport={{once:true}}/>
            </div>
            ...
            <div className='flex flex-row'>
               ...
               <motion.img src={logoImg} alt="logo"  className='w-80' whileInView={{scale:[1.2,0.8,1,0.8,1,0.8,1]}} transition={{duration:2}} viewport={{once:true}}/>
            </div>
            <div>
            ...
            <div className='flex flex-row'>
              ...
              <motion.img whileInView={{x:[-500,0],opacity:[0,1]}} transition={{duration:1}} viewport={{once:true}} src={smsImg} alt="sms"  className='w-80'/>
            </div>
            <motion.div className='flex flex-col gap-3' whileInView={{x:[1000,0],opacity:[0,1]}} transition={{duration:1.5,delay:1}} viewport={{once:true}}>
                ...
                <div className='flex flex-row gap-6'>
                    <div className='flex flex-col items-center gap-3 justify-between'>
                        ...
                        <p className='text-center text-gray-77'>اصطلاح برند به مفهومی در تجارت و بازاریابی اشاره دارد که یک شرکت، محصول یا فرد را از سایر همسان ها تمایز می دهد. تفاوت را با نهال آی تی تجربه کنید.</p>
                    </div>
                    <div className='flex flex-col items-center gap-3 justify-between'>
                     <img src={Img_2} alt="img-2" className='w-32'/>
                        <span className='font-bold text-gray-66'>ثبت لوگو</span>
                        <p className='text-center text-gray-77'>لوگو یک هویت تصویری برای رساندن مفهوم خدمت ، نشان دادن هویت یک سازمان بزرگ و یا کوچک می باشد. طراحی انواع لوگو های گرافیکی در تیم نهال آی تی</p>
                    </div>
                    <div className='flex flex-col items-center gap-3 justify-between'>
                    <img src={Img_3} alt="img-3" className='w-32'/>
                        <span className='font-bold text-gray-66'>ارسال پیامک و ایمیل انبوه</span>
                        <p className='text-center text-gray-77'>یکی از موثرترین روش تبلیغات، ارسال پیامک و ایمیل تبلیغاتی می باشد. استفاده از پنل پیامک و ایمیل یکی از بهترین راه برای اطلاع رسانی و ارتباط با مشتریان می باشد.</p>
                    </div>
                </div>   
            </motion.div> 
        ...
        <motion.div className='flex flex-row items-center bg-green-d5 px-1 py-5'  whileInView={{y:[200,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}>
