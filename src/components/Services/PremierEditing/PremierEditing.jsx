    ...
    <div className='premierEditing-content flex flex-col items-center gap-10 mb-10 mt-2'>
        <div className='flex flex-col gap-10 px-1'>
            ...
            <div className='flex flex-row items-center gap-5 justify-between'>
                ...
                <motion.img src={img_1} alt="youtube" className='w-96' whileInView={{x:[-700,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}/>
            </div>
            ...
            <div className='flex flex-row justify-between items-center'>
                ...
                <motion.img src={img_2} alt="youtube" className='w-96' whileInView={{x:[-1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}/>
            </div>
            <div>
                <motion.h4 whileInView={{x:[1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}} className='text-green-137'>خدمات تدوین ویدیو</motion.h4>
